...
### 1. Get the Code
 ...
 ```bash
 git clone https://github.com/AhmadShamli/Gridcoin-RPC-UI.git
 cd Gridcoin-RPC-UI
 ```
 
 Or to download into current directory
 ```bash
 git clone https://github.com/AhmadShamli/Gridcoin-RPC-UI.git .
 ```
 ...
 ```bash
 wget https://github.com/AhmadShamli/Gridcoin-RPC-UI/archive/refs/heads/main.zip
 unzip main.zip
 cd Gridcoin-RPC-UI-main
 ```
